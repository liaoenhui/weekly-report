...
public class MongodbUtils {
    ...
    public static List<? extends Map> select(Query query, Map map, String collectionName) {

        List<? extends Map> resultList = mongodbUtils.mongoTemplate.find(query, map.getClass(), collectionName);
        return resultList;
    }
