...
public class RabbitConfig {
    ...
    public static final String TOPIC_QUEUE_ETL_SCRIPT = "topic.etlscript";
    ...
    public Queue topicQueueETLScript() {
        return new Queue(TOPIC_QUEUE_ETL_SCRIPT);
    }
...
//    }
////    @Bean
////    public Queue fanoutQueueETLScript() {
...
//
////    @Bean
////    public Binding fanoutBindingETLScript() {
////        return BindingBuilder.bind(fanoutQueueETLScript()).to(fanoutExchange());
////    }
//    /**
//     * direct模式
