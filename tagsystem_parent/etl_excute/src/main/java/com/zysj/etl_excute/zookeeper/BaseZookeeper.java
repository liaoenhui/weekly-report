package com.zysj.etl_excute.zookeeper;
...
public class BaseZookeeper implements Watcher {
    ...
    public void ensureConnection(String url) throws Exception {
        if(zookeeper==null) connectZookeeper(url);
        if(!(zookeeper.getState().isAlive()&&zookeeper.getState().isConnected())){
            connectZookeeper(url);
        }
    }
    ...
    public String createNode(String path, String data) throws Exception {
        String messes = "已存在";
        Stat statr = this.zookeeper.exists(path, true);
        if (statr == null) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        zookeeper.connectZookeeper("47.106.37.11:2181");
